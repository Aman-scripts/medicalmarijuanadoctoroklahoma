    ...
    <section id="how-it-works" className="bg-[#0E3B2E] px-6 py-24">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-xl text-center">
          <p className="text-xs font-semibold tracking-[0.2em] text-[#B8E89A]">THE PROCESS</p>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => (
            <div key={step.number} className="rounded-3xl border border-white/10 bg-white/5 p-7 backdrop-blur">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-white/15 font-heading text-base font-medium text-white">
                {step.number}
              </div>
